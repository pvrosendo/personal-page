...
export function Footer() {
  ...
  return (
    <footer className="mx-auto flex w-full max-w-6xl flex-col gap-4 border-t border-border/70 px-6 py-7 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
